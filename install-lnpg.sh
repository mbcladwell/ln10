...
source /home/admin/.guix-profile/etc/profile 
    ...
    sudo /usr/lib/postgresql/11/bin/pg_ctl -D /var/lib/postgresql/11/main -l /var/log/postgresql/postgresql-11-main.log stop
    ...
    sudo /usr/lib/postgresql/11/bin/pg_ctl -D /var/lib/postgresql/11/main -l /var/log/postgresql/postgresql-11-main.log start
